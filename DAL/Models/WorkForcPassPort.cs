...
{
    public partial class WorkForcPassPort
    {
        ...
        public string CountryEncCode { get; set; }
        public int? BankSerial { get; set; }
        public string EngazKey { get; set; }
        public int? ReportSerial { get; set; }
        public bool? EngazPayed { get; set; }
        ...
        public int? ContractPrintedUser { get; set; }
        public bool? PermissionUploaded { get; set; }
        public DateTime? PermissionUploadDate { get; set; }
        public string PermissionUploadNum { get; set; }
    }
}
