...
{
    public partial class MsSalesOrder
    {
        public MsSalesOrder()
        {
            MsSalesOrderItemCards = new HashSet<MsSalesOrderItemCard>();
        }
        ...
        public virtual ICollection<MsSalesOrderItemCard> MsSalesOrderItemCards { get; set; }
    }
}
