...
{
    public partial class MobSalesInvoice
    {
        public MobSalesInvoice()
        {
            MobSalesInvoiceItemCards = new HashSet<MobSalesInvoiceItemCard>();
        }
        ...
        public virtual ICollection<MobSalesInvoiceItemCard> MobSalesInvoiceItemCards { get; set; }
    }
}
