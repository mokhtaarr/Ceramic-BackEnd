...
namespace DAL.Repository.Models
{
    ...
    public partial class ProjTenderContractorContractDetail
    {
        [Key]
        public int ContractorContractDetailId { get; set; }
        ...
        [InverseProperty("ProjTenderContractorContractDetails")]
