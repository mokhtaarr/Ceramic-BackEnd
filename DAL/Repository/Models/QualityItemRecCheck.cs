...
{
    [Table("Quality_ItemRecCheck")]
    public partial class QualityItemRecCheck
    {
        public QualityItemRecCheck()
        {
            QualityItemRecCheckDetails = new HashSet<QualityItemRecCheckDetail>();
        ...
        [InverseProperty("ItemRecQuality")]
        public virtual ICollection<QualityItemRecCheckDetail> QualityItemRecCheckDetails { get; set; }
        [InverseProperty("ItemRecQuality")]
